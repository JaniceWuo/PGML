...
def build_vocab():
    ...
    with open(args.split_data_path.format('train'), 'r', encoding='utf8') as f:  #train_processed.json
        data1 = json.load(f)
    with open(args.split_data_path.format('dev'), 'r', encoding='utf8') as f:    #dev_processed.json
        data2 = json.load(f)
    with open(args.split_data_path.format('test'), 'r', encoding='utf8') as f:   #test_processed.json
        data3 = json.load(f)
    ...
    with open(args.vocab_path, 'w',encoding='utf8') as f:
        f.write('\n'.join(vocab))
    return vocab
